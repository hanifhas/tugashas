package com.example.has.tugashas;
...
public class MainActivity extends AppCompatActivity {
    ...
    String no_telp = "084233156546";
    String email = "hanifmaulanahasbi@gmail.com";
    ...
    public void Email(View view) {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","hanifmaulanahasbi@gmail.com", null));
